...
function VerifyingState() {
  return (
    <div className="bg-gradient-to-br from-surface to-card border border-primary/10 rounded-3xl p-8 flex flex-col items-center gap-3">
      <PulsingIcon />
      <p className="text-base font-bold text-primary">{MESSAGES.verifying.title}</p>
